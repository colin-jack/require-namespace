...
var Namespace = function (name, propertyAssigner) {
    if (name) this.name = name;

    this.propertyAssigner = propertyAssigner;

    if (this.propertyAssigner.removeTestDoubles) this.removeTestDoubles = this.propertyAssigner.removeTestDoubles;
}
...
Namespace.prototype.lazilyExportFile = function(file, fullPathToFile) {
    ...
    this.propertyAssigner.assignProperty(fileNameMinusExtension, fullPathToFile, this)
};
